...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { city: @area.city, country: @area.country, post_code: @area.post_code, state: @area.state } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { city: @area.city, country: @area.country, post_code: @area.post_code, state: @area.state } }
