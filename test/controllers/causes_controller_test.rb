...
class CausesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cause" do
    assert_difference('Cause.count') do
      post causes_url, params: { cause: { about: @cause.about, image: @cause.image, name: @cause.name, website: @cause.website } }
    end
  ...
  test "should update cause" do
    patch cause_url(@cause), params: { cause: { about: @cause.about, image: @cause.image, name: @cause.name, website: @cause.website } }
